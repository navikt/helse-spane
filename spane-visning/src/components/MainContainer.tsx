...
export default function MainContainer() {
  ...
  const [responsSuksessPerson, setResponsSuksessPerson] = useState<
    boolean | null
  >(null);
  const [responsSuksessParagraf, setResponsSuksessParagraf] = useState<
    boolean | null
  >(null);
                ...
                <div className="tabell-container">
                  {laster ? (
                    <Loader
                      ...
                      title="venter..."
                    />
                  ) : responsSuksessPerson === null ? (
                    ""
                  ) : responsSuksessPerson ? (
                ...
                <div className="tabell-container">
                  {laster ? (
                    <Loader
                      ...
                      title="venter..."
                    />
                  ) : responsSuksessParagraf === null ? (
                    ""
                  ) : responsSuksessParagraf ? (
                    <PersonTabell
                      personer={personer}
                      anonymisert={anonymisert}
                    />
