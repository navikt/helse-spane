    ...
    return (
        ...
        >
            <Table.DataCell scope="row">
                <b> {vedtaksperiode.tilstand /*vedtaksperiode.ikkeSikkertSkjæringstidspunkt ? "Skjæringstidspunkt*: " : "Skjæringstidspunkt: "*/} </b> {/*vedtaksperiode.skjæringstidspunkt ?? 'ukjent'*/}
            </Table.DataCell>
            <Table.DataCell scope="row">
