...
function VedtaksperiodeExpandableRow(props: Props) {
    ...
    return (
      <Table.ExpandableRow
          content= {<UtvidetVedtaksperiodeTableInnhold subsumsjoner={vedtaksperiode.subsumsjoner} anonymisert={anonymisert}/>}
      ...
      >
        ...
        <Table.DataCell scope="row"> <b> Arbeidsgiver: </b> {!anonymisert ? vedtaksperiode.orgnummer: '***********'} </Table.DataCell>
